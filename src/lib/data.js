...
function normalize({ settingsRows, members, meetings, attendance, earlybird, reports }) {
  ...
  settings.monthly_required_attendance =
    parseInt(settings.monthly_required_attendance, 10) || 2;
  settings.monthly_required_percent =
    parseInt(settings.monthly_required_percent, 10) || 50;
  settings.club_goal_percent =
    parseInt(settings.club_goal_percent, 10) || 50;
  settings.early_bird_slots_per_regular_meeting =
    parseInt(settings.early_bird_slots_per_regular_meeting, 10) || 5;
